    ...
    <div className="min-h-screen bg-gray-50 dark:bg-zinc-900">
      ...
      <header className="sticky top-0 z-10 flex items-center justify-between px-6 py-4 bg-white/80 dark:bg-zinc-800/80 backdrop-blur-md shadow-sm border-b dark:border-zinc-700">
        ...
        <div className="flex items-center gap-4">
          {user && (
            <>
              ...
              <div className="relative flex items-center">
                <div className={`overflow-hidden transition-all duration-300 ease-in-out ${isSearchOpen ? 'w-64 opacity-100' : 'w-0 opacity-0'}`}>
                  <input
                    type="text"
                    placeholder="Search projects..."
                    className="w-full pl-3 pr-8 py-1.5 text-sm bg-gray-100 dark:bg-zinc-700 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    value={searchTerm}
          ...
          {user ? (
            <>
              <div className="flex items-center gap-3 pl-4 border-l dark:border-zinc-700">
                {user.photoURL ? (
                  <Image
                    src={user.photoURL}
                    alt="User"
        ...
        {!user ? (
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-md">
              Create beautiful, interactive mind maps and digital books. Sign in to start organizing your thoughts.
            </p>
            <button
              onClick={() => router.push('/login')}
